...
room.update = function()
{
	if (document.curves !== 'undefined' && isJanusWeb)
	{
		if (document.curves.length == 0)
		{
			...
			], curveType=curveType), Vector(-3.861154604276246, 9.631460172739159, 12.203220397901207), 2 ]);
			document.curves.push([ 'point', new THREE.CatmullRomCurve3([
			...
			], curveType=curveType), Vector(-5.621472433786081, 15.391807462473926, 18.71064969928776), 4 ]);
